...
from ampa_members_manager.read_only_inline import ReadOnlyStackedInline, ReadOnlyTabularInline
...
class NonrelatedStackedInline(NonrelatedInlineMixin, ReadOnlyStackedInline):
    pass


class NonrelatedTabularInline(NonrelatedInlineMixin, ReadOnlyTabularInline):
    pass
