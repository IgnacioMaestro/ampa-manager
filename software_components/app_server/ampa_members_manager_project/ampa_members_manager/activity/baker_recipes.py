...
payable_part_with_unique_activity_local_recipe = Recipe(
    ActivityPeriod, unique_activity=foreign_key(unique_activity_local_recipe))

payable_part_with_repetitive_activity_local_recipe = Recipe(
    ActivityPeriod, repetitive_activity=foreign_key(repetitive_activity_local_recipe))
