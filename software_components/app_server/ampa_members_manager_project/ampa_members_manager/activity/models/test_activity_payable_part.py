...
class TestActivityPayablePart(TestCase):
    ...
    def test_one_activity_reference_constraint_with_repetitive_and_unique(self):
        with self.assertRaises(IntegrityError):
            ...
            ActivityPayablePart.objects.create(
    ...
    def test_str(self):
        payable_part: ActivityPayablePart = baker.prepare_recipe(payable_part_with_unique_activity)

        self.assertEqual(str(payable_part), payable_part.name)

    def test_calculate_price_single_member(self):
        payable_part: ActivityPayablePart = baker.prepare_recipe(
    ...
    def test_all_same_repetitive_activity_no_payable_part(self):
        same: bool = ActivityPayablePart.all_same_repetitive_activity(ActivityPayablePart.objects.all())
    ...
    def test_all_same_repetitive_activity_two_payable_part_with_same_repetitive_activity(self):
        ...
        baker.make('ActivityPayablePart', repetitive_activity=repetitive_activity)
        baker.make('ActivityPayablePart', repetitive_activity=repetitive_activity)
