...
from ampa_members_manager.charge.use_cases.create_charge_group_with_charges.charge_group_with_charges_creator import ChargeGroupWithChargesCreator
...
class TestChargeGroupWithChargesCreator(TestCase):
    ...
    def test_create_no_single_activity(self):
        with self.assertRaises(NoSingleActivityError):
            ChargeGroupWithChargesCreator.create(SingleActivity.objects.all())
