...
class ProcessingResult:
    ...
    def get_fields_before_csv(self):
        return ProcessingResult.get_fields_csv(self.fields_before)
    
    def get_fields_after_csv(self):
        return ProcessingResult.get_fields_csv(self.fields_after)
    
    def get_fields_excel_csv(self):
        return ProcessingResult.get_fields_csv(self.fields_excel)
