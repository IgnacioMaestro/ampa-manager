...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('AMPA_MANAGER_EMAIL_USER', 'kaixo@abendanogurasoak.com')
EMAIL_HOST_PASSWORD = os.getenv('AMPA_MANAGER_EMAIL_PASS', 'tmdd ugcx ypnh eeph')
DEFAULT_FROM_EMAIL = 'Avisos AFA Abendaño <ampa@abendanogurasoak.com>'
