...
class ParentAdmin(admin.ModelAdmin):
    ...
    search_fields = ['name_and_surnames', 'normalized_name_and_surnames', 'family__surnames',
                     'family__normalized_surnames', 'phone_number', 'email', 'additional_phone_number', 'id',
