...
class AuthorizationAdmin(admin.ModelAdmin):
    ...
    def set_as_not_sent(self, request, queryset: QuerySet[AuthorizationOld]):
    ...
    def set_as_sent(self, request, queryset: QuerySet[AuthorizationOld]):
    ...
    def set_as_signed(self, request, queryset: QuerySet[AuthorizationOld]):
    ...
    def get_changeform_initial_data(self, request):
        ...
        next_number = AuthorizationOld.objects.next_order_for_year(year)
