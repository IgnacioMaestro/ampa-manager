...
class CampsRegistrationQuerySet(QuerySet):
    ...
    def of_active_course(self):
        ...
        return self.filter(camps_edition__academic_course=active_course)
    ...
    def of_previous_courses(self):
        active_course: AcademicCourse = ActiveCourse.load()
        return self.filter(camps_edition__academic_course__initial_year__lt=active_course.initial_year)
