...
class MembersImporter(BaseImporter):
    ...
    COLUMNS_TO_IMPORT = [
        ...
        ExcelColumn(6, BaseImporter.parent_2_name_and_surnames),
        ExcelColumn(7, BaseImporter.parent_2_phone_number),
        ExcelColumn(8, BaseImporter.parent_2_email),
        ExcelColumn(9, BaseImporter.child_1_name),
        ExcelColumn(10, BaseImporter.child_1_year_of_birth),
        ExcelColumn(11, BaseImporter.child_1_level),
        ExcelColumn(12, BaseImporter.child_2_name),
        ExcelColumn(13, BaseImporter.child_2_year_of_birth),
        ExcelColumn(14, BaseImporter.child_2_level),
        ExcelColumn(15, BaseImporter.child_3_name),
        ExcelColumn(16, BaseImporter.child_3_year_of_birth),
        ExcelColumn(17, BaseImporter.child_3_level),
        ExcelColumn(18, BaseImporter.child_4_name),
        ExcelColumn(19, BaseImporter.child_4_year_of_birth),
        ExcelColumn(20, BaseImporter.child_4_level),
    ]
