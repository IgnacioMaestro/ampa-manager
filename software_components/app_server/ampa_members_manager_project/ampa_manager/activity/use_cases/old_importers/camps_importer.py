...
from ampa_manager.activity.use_cases.old_importers.camps_registration_importer import CampsRegistrationImporter
...
class CampsImporter:
    ...
    COLUMNS_TO_IMPORT = [
        [0, FieldsFormatters.format_email, KEY_FAMILY_EMAIL, LABEL_FAMILY_EMAIL],
        [1, FieldsFormatters.format_name, KEY_PARENT_NAME_AND_SURNAMES, LABEL_PARENT_NAME_AND_SURNAMES],
        [2, FieldsFormatters.format_phone, KEY_PARENT_PHONE_NUMBER, LABEL_PARENT_PHONE_NUMBER],
        [3, FieldsFormatters.format_email, KEY_PARENT_EMAIL, LABEL_PARENT_EMAIL],
        [4, FieldsFormatters.format_iban, KEY_BANK_ACCOUNT_IBAN, LABEL_BANK_ACCOUNT_IBAN],
        [5, FieldsFormatters.format_name, KEY_CHILD_NAME, LABEL_CHILD_NAME],
        [6, FieldsFormatters.format_name, KEY_CHILD_SURNAMES, LABEL_CHILD_SURNAMES],
        [7, FieldsFormatters.format_integer, KEY_CHILD_YEAR_OF_BIRTH, LABEL_CHILD_YEAR_OF_BIRTH],
        [8, FieldsFormatters.format_level, KEY_CHILD_LEVEL, LABEL_CHILD_LEVEL],
    ]
    ...
    def process_row(cls, row: ExcelRow, camps_edition: CampsEdition) -> ImportRowResult:
        ...
        try:
            family_result = FamilyImporter.import_family(
                ...
                family_email=row.get(cls.KEY_FAMILY_EMAIL))
