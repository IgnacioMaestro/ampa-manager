...
1. Notificar inicio de campaña  /membership_campaign/notify
- xxxx.xxxx
2. Importar nuevos socios       /membership_campaign/import
3. Copiar socios del año pasado /membership_campaign/copy
4. Generar remesa               /membership_campaign/generate_remittance
5. Notificar cobro de la remesa /membership_campaign/notify_remittance
- MembershipRemittance.notified_at
"""

class MembersCampaignView(View):
    HTML_TEMPLATE = 'membership_campaign/membership_campaign.html'
    VIEW_NAME = 'membership_campaign'
