...
urlpatterns = [
    ...
    path('members-campaign/import-new-members/', ImportNewMembersView.as_view(), name='import_new_members'),
    path('members-campaign/notify/', NotifyMembershipCampaignView.as_view(), name='notify_members_campaign'),
    path('members-campaign/import-last-course-members/', ImportLastCourseMembersView.as_view(), name='import_last_course_members'),
