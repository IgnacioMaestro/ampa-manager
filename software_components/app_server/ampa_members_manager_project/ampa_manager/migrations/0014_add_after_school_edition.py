...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ampa_manager', '0013_add_after_school'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('after_school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ampa_manager.afterschool', verbose_name='AfterSchool')),
            ],
        ),
