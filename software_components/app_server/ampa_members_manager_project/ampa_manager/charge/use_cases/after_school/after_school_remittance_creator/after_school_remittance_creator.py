...
class AfterSchoolRemittanceCreator:
    ...
    def create_full(self) -> tuple[Optional[AfterSchoolRemittance], Optional[RemittanceCreatorError]]:
        return self.create_with_calculator(calculator=FullAmountReceiptCalculator())

    def create_half(self) -> tuple[Optional[AfterSchoolRemittance], Optional[RemittanceCreatorError]]:
