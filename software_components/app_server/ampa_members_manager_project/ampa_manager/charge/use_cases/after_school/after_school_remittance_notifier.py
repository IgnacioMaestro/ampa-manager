...
class AfterSchoolRemittanceNotifier:
    ...
    @classmethod
    def get_receipt_emails(cls, receipt) -> list[str]:
        return []
        # self.emails = []
        # for receipt in self.remittance.receipts.all():
    ...
    @classmethod
    def get_account_last_4_digits(cls, receipt: AfterSchoolReceipt):
        return receipt.after_school_registration.child.family.after_school_holder.bank_account.iban[-4:]
