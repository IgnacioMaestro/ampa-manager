...
class RemittanceGeneratorFromAfterSchoolRemittance:
    ...
    def generate(self) -> Remittance:
        ...
        return Remittance(receipts, str(self.__after_school_remittance), self.__after_school_remittance.created_at, self.__after_school_remittance.payment_date, self.__after_school_remittance.concept)
