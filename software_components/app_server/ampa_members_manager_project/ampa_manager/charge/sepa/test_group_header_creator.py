...
class TestGroupHeaderCreator(TestCase):
    ...
    def test_create(self):
        ...
        self.assertTrue(isinstance(group_header_39.initg_pty, PartyIdentification32))
    ...
    def test_create_party_identification(self):
        ...
        self.assertTrue(isinstance(party_identification_32.id, Party6Choice))
    ...
    def test_create_party_choice(self):
        ...
        self.assertTrue(isinstance(party_choice.org_id, OrganisationIdentification4))
        self.assertTrue(isinstance(party_choice.org_id.othr, list))
        self.assertEqual(len(party_choice.org_id.othr), 1)
        self.assertTrue(isinstance(party_choice.org_id.othr[0], GenericOrganisationIdentification1))
